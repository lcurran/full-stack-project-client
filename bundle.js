...
/***/ function(module, exports, __webpack_require__) {
	...
	var authUiHandlers = function authUiHandlers() {
	  $('#sign-in-nav').on('click', navFormCollapse);
	  $('#sign-up-nav').on('click', navFormCollapse);
	  $('#change-password-nav').on('click', navFormCollapse);
	};
	...
	module.exports = {
	  ...
	  authUiHandlers: authUiHandlers,
	  navFormCollapse: navFormCollapse
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(4);
	var form = __webpack_require__(40);

	var characterListRefresh = function characterListRefresh() {
	  event.preventDefault();
	  $('#character-list').html('');
	  api.listCharacters().done(ui.listCharacters, listHandlers).fail();
	};

	var onListCharacters = function onListCharacters() {
	  event.preventDefault();
	  api.listCharacters().done(ui.listCharacters, listHandlers).fail(ui.failure);
	};
	...
	var onDeleteCharacter = function onDeleteCharacter(event) {
	  event.preventDefault();
	  var id = event.target.name;
	  api.deleteCharacter(id).done(characterListRefresh).fail(ui.failure);
	};
	...
	var onSaveEditCharacter = function onSaveEditCharacter(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.editCharacter(data).done(characterListRefresh).fail(ui.failure);
	};

	var onNewCharacterForm = function onNewCharacterForm() {
	  event.preventDefault();
	  api.getStats().done(ui.statsForm, statHandler).fail(ui.failure);
	  api.getSkills().done(ui.skillsForm, skillHandler).fail(ui.failure);
	  api.getSpells().done(ui.spellsForm, spellHandler).fail(ui.failure);
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onListCharacters: onListCharacters,
	  onNewCharacterForm: onNewCharacterForm,
	  onDeleteCharacter: onDeleteCharacter,
	  onViewCharacter: onViewCharacter,
	  onEditCharacter: onEditCharacter,
	  onSaveEditCharacter: onSaveEditCharacter
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getSpells = function getSpells() {
	  return $.ajax({
	    url: app.host + '/spells',
	    method: "GET"
	  });
	...
	var newCharacter = function newCharacter(data) {
	  return $.ajax({
	    url: app.host + '/characters/',
	    method: "POST",
	    headers: {
	...
	var newStat = function newStat(data) {
	  return $.ajax({
	...
	var addSpell = function addSpell(data) {
	  return $.ajax({
	...
	var editCharacter = function editCharacter(data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var characterInfoTemplate = __webpack_require__(11);
	var characterEditTemplate = __webpack_require__(34);
	var characterListingTemplate = __webpack_require__(35);
	var skillRow = __webpack_require__(37);
	var statRow = __webpack_require__(38);
	var spellForm = __webpack_require__(39);
	...
	var skillsForm = function skillsForm(skills) {
	  $('.skills').append(skillRow(skills));
	};

	var spellsForm = function spellsForm(spells) {
	...
	module.exports = {
	  failure: failure,
	  success: success,
	  viewCharacterSuccess: viewCharacterSuccess,
	  loadEditCharacter: loadEditCharacter,
	  listCharacters: listCharacters,
	  statsForm: statsForm,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<table class=\"table\">\n  <thead>\n    <th>Name</th>\n    <th>Race</th>\n    <th>Age</th>\n    <th>Gender</th>\n    <th>Alignment</th>\n    <th>Deity</th>\n  </thead>\n  <tbody>\n    <tr>\n      <td>"
	    ...
	    + "</td>\n      <td>"
	    + alias2(alias1((depth0 != null ? depth0.alignment : depth0), depth0))
	    + "</td>\n      <td>"
	    + alias2(alias1((depth0 != null ? depth0.deity : depth0), depth0))
	    + "</td>\n    </tr>\n  </tbody>\n</table>\n<div class=\"row\">\n  <div class=\"col-xs-6\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(31),depth0,{"name":"character-stat-view","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "  </div>\n  <div class=\"col-xs-6\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(32),depth0,{"name":"character-skill-view","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "  </div>\n</div>\n<div class=\"row\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(33),depth0,{"name":"character-spell-view","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "          <tr><td>"
	    + container.escapeExpression(((helper = (helper = helpers.stat_value || (depth0 != null ? depth0.stat_value : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"stat_value","hash":{},"data":data}) : helper)))
	    + "</td></tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, options, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=helpers.blockHelperMissing, buffer = 
	  "<div class=\"row\">\n  <div class=\"col-xs-6\">\n    <table class=\"table\">\n      <thead>\n        <th>Stat</th>\n      </thead>\n      <tbody>\n";
	  stack1 = ((helper = (helper = helpers.stats || (depth0 != null ? depth0.stats : depth0)) != null ? helper : alias2),(options={"name":"stats","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
	  if (!helpers.stats) { stack1 = alias4.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  buffer += "      </tbody>\n    </table>\n  </div>\n  <div class=\"col-xs-6\">\n    <table class=\"table\">\n      <thead>\n        <th>Value</th>\n      </thead>\n      <tbody>\n";
	  stack1 = ((helper = (helper = helpers.character_stats || (depth0 != null ? depth0.character_stats : depth0)) != null ? helper : alias2),(options={"name":"character_stats","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
	  if (!helpers.character_stats) { stack1 = alias4.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  return buffer + "      </tbody>\n    </table>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "          <tr><td>"
	    + container.escapeExpression(((helper = (helper = helpers.skill_value || (depth0 != null ? depth0.skill_value : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"skill_value","hash":{},"data":data}) : helper)))
	    + "</td></tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, options, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=helpers.blockHelperMissing, buffer = 
	  "<div class=\"row\">\n  <div class=\"col-xs-6\">\n    <table class=\"table\">\n      <thead>\n        <th>Skill</th>\n      </thead>\n      <tbody>\n";
	  stack1 = ((helper = (helper = helpers.skills || (depth0 != null ? depth0.skills : depth0)) != null ? helper : alias2),(options={"name":"skills","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
	  if (!helpers.skills) { stack1 = alias4.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  buffer += "      </tbody>\n    </table>\n  </div>\n  <div class=\"col-xs-6\">\n    <table class=\"table\">\n      <thead>\n        <th>Value</th>\n      </thead>\n      <tbody>\n";
	  stack1 = ((helper = (helper = helpers.character_skills || (depth0 != null ? depth0.character_skills : depth0)) != null ? helper : alias2),(options={"name":"character_skills","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
	  if (!helpers.character_skills) { stack1 = alias4.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  return buffer + "      </tbody>\n    </table>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  "<table class=\"table\">\n  <thead>\n    <th>Spells</th>\n    <th>Description</th>\n  </thead>\n  <tbody>\n";
	  stack1 = ((helper = (helper = helpers.spells || (depth0 != null ? depth0.spells : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"spells","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
	  if (!helpers.spells) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  return buffer + "  </tbody>\n</table>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<input type=\"text\" name=\"character[name]\" id=\"name\" placeholder=\"Name\">\n<input type=\"text\" name=\"character[race]\" id=\"race\" placeholder=\"Race\">\n<input type=\"text\" name=\"character[gender]\" id=\"gender\" placeholder=\"Gender\">\n<input type=\"text\" name=\"character[age]\" id=\"age\" placeholder=\"Age\">\n<input type=\"text\" name=\"character[alignment]\" id=\"alignment\" placeholder=\"Alignment\">\n<input type=\"text\" name=\"character[deity]\" id=\"deity\" placeholder=\"Deity\">\n\n\n\n\n<!-- <div class=\"form-group\">\n  <label for=\"name\">"
	    ...
	    + "</label>\n  <input type=\"text\" name=\"character[race]\" class=\"form-control\" id=\"race\" placeholder=\"Race\">\n</div>\n<div class=\"form-group\">\n  <label for=\"gender\">"
	    ...
	    + "</label>\n  <input type=\"text\" name=\"character[gender]\" class=\"form-control\" id=\"gender\" placeholder=\"Gender\">\n</div>\n<div class=\"form-group\">\n  <label for=\"age\">"
	    ...
	    + "</label>\n  <input type=\"text\" name=\"character[age]\" class=\"form-control\" id=\"age\" placeholder=\"Age\">\n</div>\n<div class=\"form-group\">\n  <label for=\"alignment\">"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(36),depth0,{"name":"character-row","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.characters : depth0), depth0),{"name":"characters","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<tr>\n  <td>"
	    ...
	    + alias4(alias5((depth0 != null ? depth0.id : depth0), depth0))
	    + " type=\"button\" class=\"edit btn btn-default\">Edit</button>\n      <button name="
	    + alias4(alias5((depth0 != null ? depth0.id : depth0), depth0))
	    + " type=\"button\" class=\"delete btn btn-default\">Delete</button>\n    </div>\n  </td>\n</tr>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  stack1 = ((helper = (helper = helpers.skills || (depth0 != null ? depth0.skills : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"skills","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
	  if (!helpers.skills) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  return buffer;
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  stack1 = ((helper = (helper = helpers.stats || (depth0 != null ? depth0.stats : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"stats","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
	  if (!helpers.stats) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  return buffer;
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var charactersData = function charactersData(form) {
	  var userObj = {
	    "user_id": app.user.id
	  };
	  var formObj = getFormFields(form);
	  var data = {};
	  data['characters'] = Object.assign(userObj, formObj);
	  return data;
	};

	var characterData = function characterData(form) {
	  var userObj = {
	    "user_id": app.user.id
	  };
	  var formObj = getFormFields(form);
	...
	var spellData = function spellData(form) {
	  var userObj = {
	    "character_id": app.character.id
	  };
	  var formObj = getFormFields(form);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayRoll = function displayRoll(roll) {
